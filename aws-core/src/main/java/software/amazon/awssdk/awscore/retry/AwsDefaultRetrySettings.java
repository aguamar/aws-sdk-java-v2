...
/**
 * Default retry settings of the clients communicating with AWS services.
 */
@SdkInternalApi
public final class AwsDefaultRetrySettings {

    static final Set<String> RETRYABLE_ERROR_CODES;
    static final Set<String> THROTTLING_ERROR_CODES;
    static final Set<String> CLOCK_SKEW_ERROR_CODES;
    ...
    private AwsDefaultRetrySettings() {
    }
}
