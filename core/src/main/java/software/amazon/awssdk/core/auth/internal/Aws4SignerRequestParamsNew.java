...
import software.amazon.awssdk.core.auth.varunknSigners.SignerContext;
 ...
 */
public final class Aws4SignerRequestParamsNew {
    ...
    public Aws4SignerRequestParamsNew(SdkHttpFullRequest.Builder httpRequest,
        ...
        this.signingDateTimeMilli = signingDateOverride != null ? signingDateOverride
            .getTime() : getSigningDate(signerContext.getAttribute(TIME_OFFSET));
